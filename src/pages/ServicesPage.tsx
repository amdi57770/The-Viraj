    ...
    <main className="bg-white pt-[100px]">
      ...
      <section className="bg-charcoal text-white py-[160px] px-8 lg:px-16">
        <div className="max-w-[1440px] mx-auto text-center flex flex-col items-center">
          <FadeUp>
            <span className="text-xs tracking-[0.2em] uppercase font-semibold text-gray-400 mb-8 block">
              Our Disciplines
            </span>
      ...
      <section className="bg-alabaster py-[160px] px-8 lg:px-16">
        <div className="max-w-[1440px] mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-6 gap-6 auto-rows-[280px]">
            {/* Card 1: Large */}
            <FadeUp delay={0.1} className="md:col-span-4 bg-white p-10 flex flex-col justify-end border border-gray-100 hover:bg-gray-50 transition-colors duration-500">
            ...
            {/* Card 2: Small */}
            <FadeUp delay={0.2} className="md:col-span-2 bg-white p-10 flex flex-col justify-end border border-gray-100 hover:bg-gray-50 transition-colors duration-500">
            ...
            {/* Card 3: Small */}
            <FadeUp delay={0.3} className="md:col-span-2 bg-white p-10 flex flex-col justify-end border border-gray-100 hover:bg-gray-50 transition-colors duration-500">
            ...
            {/* Card 4: Large */}
            <FadeUp delay={0.4} className="md:col-span-4 bg-white p-10 flex flex-col justify-end border border-gray-100 hover:bg-gray-50 transition-colors duration-500">
            ...
            {/* Card 5: Medium-Small */}
            <FadeUp delay={0.5} className="md:col-span-3 bg-white p-10 flex flex-col justify-end border border-gray-100 hover:bg-gray-50 transition-colors duration-500">
            ...
            {/* Card 6: Medium-Small */}
            <FadeUp delay={0.6} className="md:col-span-3 bg-white p-10 flex flex-col justify-end border border-gray-100 hover:bg-gray-50 transition-colors duration-500">
      ...
      <section className="py-[160px] px-8 lg:px-16 bg-white">
        <div className="max-w-[1440px] mx-auto space-y-[120px]">
          <FadeUp className="text-center mb-24">
            <span className="text-xs tracking-[0.2em] uppercase font-semibold text-gray-400 block mb-6 font-sans">
              Process
            </span>
