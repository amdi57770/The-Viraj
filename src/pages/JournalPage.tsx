  ...
  return (
    <main className="bg-white pt-[160px] min-h-screen">
      ...
      <section className="px-8 lg:px-16 max-w-[1440px] mx-auto mb-16">
        <FadeUp>
          <span className="text-xs tracking-widest uppercase font-semibold text-neutral-400 mb-6 block font-sans">
            The Journal
          </span>
          <h1 className="font-serif text-5xl lg:text-7xl leading-[1.1] tracking-tight text-charcoal mb-6">
            Ideas, Observations & Craft
          </h1>
          <p className="text-neutral-500 text-lg font-sans max-w-2xl">
            ...
            <button
              ...
              className={`px-6 py-2 rounded-full text-xs tracking-widest uppercase font-medium transition-all duration-300 font-sans ${
                activeFilter === filter
                  ...
                  : 'bg-transparent text-charcoal border border-neutral-200 hover:border-neutral-400'
              }`}
            >
              {filter}
            </button>
      ...
      <section className="px-8 lg:px-16 max-w-[1440px] mx-auto mb-[160px]">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
          <div className="lg:col-span-7">
            <FadeUp>
              <div className="w-full aspect-[16/9] bg-neutral-200 overflow-hidden group cursor-pointer">
                <img 
          ...
          <div className="lg:col-span-5">
            <FadeUp delay={0.2}>
              <span className="text-[10px] tracking-widest uppercase font-semibold text-charcoal mb-6 block font-sans">
              ...
              <p className="text-neutral-500 text-base leading-relaxed font-sans mb-8">
              ...
              <a 
                href="#" 
                className="inline-flex items-center gap-4 text-sm tracking-widest uppercase font-medium border-b border-charcoal pb-1 hover:text-neutral-500 hover:border-neutral-500 transition-colors font-sans"
              >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 lg:gap-16">
            {filteredArticles.map((article, index) => (
              <FadeUp key={article.id} delay={index * 0.1} className="group cursor-pointer flex flex-col h-full">
                <div className="w-full aspect-[4/3] bg-neutral-200 mb-6 overflow-hidden">
                  <img 
                ...
                <div className="flex justify-between items-start mb-4">
                  <span className="text-[10px] tracking-widest uppercase text-neutral-400 font-sans mt-1">
                    {article.date}
                  </span>
                  <span className="text-[10px] tracking-widest uppercase text-charcoal border border-neutral-200 px-3 py-1 rounded-full font-sans">
                    {article.category}
                  </span>
                </div>
                <h3 className="font-serif text-2xl text-charcoal mb-3 group-hover:text-neutral-600 transition-colors">
                  {article.title}
                </h3>
                <p className="text-neutral-500 text-sm font-sans line-clamp-1 mt-auto">
                  {article.excerpt}
                </p>
              </FadeUp>
            ))}
          ...
          <FadeUp>
            ...
            <form className="flex flex-col sm:flex-row max-w-lg mx-auto gap-4 border-b border-white/30 pb-2 focus-within:border-white transition-colors">
              <input 
                ...
                className="bg-transparent w-full text-sm focus:outline-none text-white placeholder-neutral-400 font-sans py-2" 
              />
              <button 
                type="button" 
                className="text-sm uppercase tracking-widest font-medium hover:text-neutral-300 transition-colors font-sans whitespace-nowrap py-2"
              >
                Subscribe
              </button>
            </form>
