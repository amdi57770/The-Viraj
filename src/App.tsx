...
import WorkPage from './pages/PortfolioPage';
import StudioPage from './pages/AboutPage';
...
const NotFound = () => (
  <main className="flex-grow flex flex-col items-center justify-center text-center py-[160px] px-8 lg:px-16">
    <FadeUp>
      ...
      <p className="text-gray-500 text-lg font-sans max-w-md mx-auto mb-10">
        The space you are looking for does not exist or has been moved.
      </p>
